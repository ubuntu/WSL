# /usr/bin/python
""" Parses the .clang-tidy-ignore file at the root of the repository
...
def files_to_lint(repo_root: str) -> List[str]:
    extensions = ["h", "hpp", "c", "cpp", "cc", "hh", "cxx", "hx"]
    base_dir = "DistroLauncher"
    sources = []
    ...
    # Additionally (and preferrably), we can use a .clang-tidy-ignore file
    ...
    ct_ignore = os.path.join(repo_root, '.clang-tidy-ignore')

...
(if the runner is enabled in the command line) to post a series of pull
...
def main():
    """ Implements a pipeline of PR review comment generators enabled by
    the command line posting the results on the PR matching the 
    repository name and pull request id parameters."""

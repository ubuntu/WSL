...
func TestSetupWithCloudInit(t *testing.T) {
	testCases := map[string]struct {
		wantUserToBeRoot bool
		wantFile         string
	}{
		"With default user":    {wantFile: "/etc/with_default_user.done"},
		"Without default user": {wantUserToBeRoot: true, wantFile: "/home/testuser/with_default_user.done"},
	}
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			testWhetherUserIsRoot(t, tc.wantUserToBeRoot)

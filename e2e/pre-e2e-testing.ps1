...
# Build the appx bundle as usual
msbuild ./DistroLauncher.sln /t:Build /m /nr:false /p:Configuration=Debug /p:AppxBundle=Always /p:AppxBundlePlatforms="x64" /p:UapAppxPackageBuildMode=SideloadOnly -verbosity:normal
FailFast ($LastExitCode)
...
$Script = "./AppPackages/Ubuntu/$OutputDir/Add-AppDevPackage.ps1"
